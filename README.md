...
Building autonomous agents, trading/analytics systems, and the occasional experiment I'm not sure will work.
...
| [**Stock-analyzer**](https://github.com/Fahad-Sajeem/Stock-analyzer) | A techno-funda hybrid that screens Indian equities (NSE) on fundamentals + technicals and produces swing-trade signals with entry/stop/target levels — including an honest, published backtest verdict on what didn't work. |
